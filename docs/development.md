...
**Note**: To install services [insight-api](https://github.com/leoreinaux/bc-insight-api) and [insight-ui](https://github.com/leoreinaux/bc-insight-ui) you'll need to clone the repositories locally.
